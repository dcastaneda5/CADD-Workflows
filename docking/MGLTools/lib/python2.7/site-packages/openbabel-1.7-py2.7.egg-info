...
Name: openbabel
Version: 1.7
Summary: openbabel: Python interface to the Open Babel chemistry library
Home-page: http://openbabel.org/
Author: Noel O'Boyle
Author-email: openbabel-scripting@lists.sourceforge.net
License: http://www.gnu.org/copyleft/gpl.html
Description: The Open Babel package provides a Python wrapper
